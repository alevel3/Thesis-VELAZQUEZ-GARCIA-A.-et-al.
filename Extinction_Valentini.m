...
%%% USING MEEs => Valentini et al. 2018

function[MEE,EXT,RC] = Extinction_Valentini(NH42SO4,NH4NO3,Org,Abs,EXT_525)%,NO2,Rayleigh)
%% Xdata -> Input
...
%%calcule
Bext_PM1_calc_MLR = nansum([Ext_NH42SO4 Ext_NH4NO3 Ext_Org],2);%Ext_NO2  Rayleigh

RC = [MEE(1)*nanmean(NH42SO4);...
    MEE(2)*nanmean(NH4NO3);...
    MEE(3)*nanmean(Org)];

EXT = Bext_PM1_calc_MLR + Abs;
end