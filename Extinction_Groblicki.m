...
%%% USING MEEs => Groblicki et al. 1981

function[MEE,Bext_PM1_calc_MLR,RC] = Extinction_Groblicki(NH42SO4,NH4NO3,Org,BC,EXT_525)%,NO2,Rayleigh);
%% Xdata -> Input
