...
%%fitlm mdl
function[MEE,CInt,Bext_PM1_calc_MLR,RC] = Extinction_4s(NH42SO4,NH4NO3,Org,BC,EXT_525)%,NO2,Rayleigh);
%% Xdata -> Input
...
%%lsqlin 
Ext_NH42SO4 = MEE(1).*NH42SO4;%*1.53;%%f(RH)45% Pitchofrd t 2007 => slope increase overestimatin
Ext_NH4NO3 = MEE(2).*NH4NO3;%*1.53;
Ext_Org = MEE(3).*Org;
Ext_BC = MEE(4).*BC;
...
%%calcule
Bext_PM1_calc_MLR = sum([Ext_NH42SO4 Ext_NH4NO3 Ext_Org Ext_BC],2);%Ext_NO2  Rayleigh
